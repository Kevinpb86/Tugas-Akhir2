...
class Localization {
  ...
  static const Map<String, Map<String, String>> _localizedValues = {
    'id': {
      ...
      'account_menu_edit_profile': 'Ubah Profil',
      ...
      'account_section_demo': 'DEMONSTRASI',
      'account_menu_demo': 'Demonstrasi',
      'account_menu_logout': 'Keluar',
      'account_popup_title': 'Pilih Bahasa',
      'account_lang_changed': 'Bahasa diubah ke',

      // Quake & Disaster
      'quake_info_title': 'Informasi Gempa Bumi',
      'quake_time': 'Waktu',
      'quake_location': 'Lokasi Gempa',
      'quake_distance': 'Jarak',
      'quake_felt_button': 'Saya juga merasakannya',
      'quake_magnitude': 'Magnitudo',
      'quake_depth': 'Kedalaman',
      'quake_risk_cause': 'Penyebab Risiko',
      'quake_hazard_potential': 'Potensi Bahaya',
      'quake_latest': 'Gempabumi Terkini',
      'quake_epicenter': 'Pusat Gempa',
      'quake_date': 'Tanggal',
    ...
    'en': {
      ...
      'account_section_demo': 'DEMONSTRATION',
      'account_menu_demo': 'Demonstration',
      'account_menu_logout': 'Logout',
      'account_popup_title': 'Select Language',
      'account_lang_changed': 'Language changed to',

      // Quake & Disaster
      'quake_info_title': 'Earthquake Information',
      'quake_time': 'Time',
      'quake_location': 'Earthquake Location',
      'quake_distance': 'Distance',
      'quake_felt_button': 'I felt it too',
      'quake_magnitude': 'Magnitude',
      'quake_depth': 'Depth',
      'quake_risk_cause': 'Risk Cause',
      'quake_hazard_potential': 'Hazard Potential',
      'quake_latest': 'Latest Earthquake',
      'quake_epicenter': 'Epicenter',
      'quake_date': 'Date',

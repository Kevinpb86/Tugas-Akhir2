...
class _SemuaVideoPageState extends State<SemuaVideoPage> {
  ...
  Future<void> _loadMoreVideos() async {
    ...
    if (_isLoadingMore || _nextPageToken == null || _nextPageToken!.isEmpty) return;
    ...
    try {
      final response = await _edukasiService.fetchVideos(pageToken: _nextPageToken);
      setState(() {
  ...
  Widget _buildFeaturedVideo() {
    ...
    final bool isPlaying = _playingVideoId == _featuredVideo!['id'] && _youtubeController != null;
  ...
  Widget _buildVideoCard(Map<String, dynamic> video) {
    final bool isPlaying = _playingVideoId == video['id'] && _youtubeController != null;
            ...
            child: _isLoading
                ...
                : _error != null
                    ...
                    : ListView.builder(
                        ...
                        itemCount: _videos.length + (_featuredVideo != null ? 1 : 0) + 1,
                        itemBuilder: (context, index) {
                          ...
                          final videoIndex = _featuredVideo != null ? index - 1 : index;
